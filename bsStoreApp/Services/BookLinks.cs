...
namespace Services
{
    public class BookLinks : IBookLinks
    {
        ...
        private readonly IDataShaper<BookDto> _dataShapper;
        public BookLinks(LinkGenerator linkGenerator, IDataShaper<BookDto> dataShapper)
        {
